var defaultSettings = {
  ...
  panelAttr       : {type  : 'panel', title : 'プロパティが一致するパスに絞る', items : {
    ...
    _layer            : {type: 'checkbox', value: false, title: 'レイヤー', group: 'group2', name: 'attr'},
    _name             : {type: 'checkbox', value: false, title: 'パス名', group: 'group2', name: 'attr'},
    // _strokeOverprint  : {type: 'checkbox', value: false, title: 'オーバープリント', group: 'group3', name: 'attr'},
    // _evenodd          : {type: 'checkbox', value: false, title: 'evenodd', group: 'group3', name: 'attr'},
