var defaultSettings = {
  ...
  rbMerge         : {type: 'radiobutton', title: '連結対象', items: ['両方', '他のパスとの連結', '同じパスの両端を連結']},
  ...
  panelAttr       : {type  : 'panel', title : 'プロパティが一致するパスに絞る', items : {
    ...
    _strokeCap        : {type: 'checkbox', value: false, title: '線端', group: 'stroke2', name: 'attr'},
    ...
    _blendingMode     : {type: 'checkbox', value: false, title: '描画モード', group: 'group1', name: 'attr'},
    _name             : {type: 'checkbox', value: false, title: 'パス名', group: 'group2', name: 'attr'},
    _fillOverprint    : {type: 'checkbox', value: false, title: '塗りにオーバープリント', group: 'group2', name: 'attr'},
    _layer            : {type: 'checkbox', value: false, title: 'レイヤー', group: 'group3', name: 'attr'},
    _strokeOverprint  : {type: 'checkbox', value: false, title: '線にオーバープリント', group: 'group3', name: 'attr'},
    _pixelAligned     : {type: 'checkbox', value: false, title: 'ピクセルグリッドに整合', group: 'group4', name: 'attr'},
    // _evenodd          : {type: 'checkbox', value: false, title: 'evenodd', group: 'group4', name: 'attr'},
  }},
